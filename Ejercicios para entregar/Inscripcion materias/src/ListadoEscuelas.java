...
public class ListadoEscuelas {
    ...
    private String []Lista = new String[]{"Nombre","Direccion"};
    private int numerorow;
    private int numerocolum;
    private String SelectNombre;
    private String SelectDireccion;
    private String idinstitucion;

    public ListadoEscuelas(){
        ...
        table1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                SelectDireccion =(String) dtm.getValueAt(numerorow,1);
    ...
    public void select(){
        String sqlprod = "select Nombre,Direccion from institucion where Visible = 1";
    ...
    public void select_updatte() {
        String sqlprod = "select id_institucion from institucion where Nombre = '" + SelectNombre + "' && Direccion= '"+SelectDireccion+"'";
    ...
    public void update(){
        ...
        try{
            ...
            ps = con.prepareStatement("UPDATE institucion SET Nombre = ?,Direccion = ? where id_institucion ='"+idinstitucion+"'");
            ...
            ps.setString(2,SelectDireccion);
    ...
    public void update_delete(){
        ...
        PreparedStatement ps = null;
        try{
            ps = con.prepareStatement("UPDATE institucion SET Visible = ? where id_institucion ='"+idinstitucion+"'");
            ps.setInt(1,0);
            ps.executeUpdate();
